...
/* package rosalind-lgis-0.1.0.0 */
#ifndef VERSION_rosalind_lgis
#define VERSION_rosalind_lgis "0.1.0.0"
#endif /* VERSION_rosalind_lgis */
#ifndef MIN_VERSION_rosalind_lgis
#define MIN_VERSION_rosalind_lgis(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_rosalind_lgis */
...
#define CURRENT_COMPONENT_ID "rosalind-lgis-0.1.0.0-inplace-rosalind-lgis"
